...
spdadd 192.168.1.31 192.168.1.32 any -P in ipsec esp/transport//require ah/transport//require;
spdadd 192.168.1.32 192.168.1.31 any -P out ipsec esp/transport//require ah/transport//require;
